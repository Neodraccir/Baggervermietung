...
var loadGlobalVariables = function () {
  addGlobalVar({
    ...
    startDebugMode: () => {
      if (window.localStorage.getItem("console.log") != "true") {
        window.localStorage.setItem("console.log", "true");
        console.log("turned debugging on");
      } else {
        window.localStorage.setItem("console.log", "false");
        console.log("turned debugging off");
      }
    },
  });
};
