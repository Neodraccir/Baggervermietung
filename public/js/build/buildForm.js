...
buildForm = async function (parent) {
  try {
    ...
    form = new ElementWithAttributes(
      "form",
      [
    ...
    form.submitButton = new ElementWithAttributes(
      "input",
      [
    ...
    var distanceDiv = new ElementWithAttributes(
      "div",
      [
    ...
    var priceDiv = new ElementWithAttributes(
      "div",
      [
    ...
    var deliverDiv = new ElementWithAttributes(
      "div",
